<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.master" AutoEventWireup="true" CodeFile="All_Order.aspx.cs" Inherits="Admin_All_Order" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="cart_description">
                                ...
                                <p class="product-name"><span style="font-size: large;color: #A22424;"><asp:Label ID="Label8" runat="server" Text='<%# Eval("Username") %>'></asp:Label></span></p>
                                <small class="cart_ref" style="font-size: medium;">  <asp:Label ID="Label5" runat="server" Text='<%# Eval("Mobile_Number") %>'></asp:Label></small><br>
                                <small style="font-size: medium;"> <asp:Label ID="Label7" runat="server" Text='<%# Eval("Email_Id") %>'></asp:Label></small><br>   
                            ...
                            <p class="product-name"><span style="font-size: large;color: #A22424;"><asp:Label ID="Label6" runat="server" Text='<%# Eval("Parking_Name") %>'></asp:Label></span></p>
                      ...
                      style="font-size: larger;color: white;border-radius: 0px;padding: 7px;background-color: #00d999;"  
                      runat="server" Text="Cancel Booking" CommandName="Can" CommandArgument='<%# Eval("Id") %>' OnClientClick="if ( !confirm('Are you sure you want to Cancel ?')) return false;"  /> 
  ...
  Admin_Booking_Parking.To_Date,
   ...
   Admin_Booking_Parking.Purpose,
	...
	Admin_Login.Username 
	 FROM Admin_Login Right OUTER JOIN Admin_Booking_Parking ON Admin_Login.Registration_Id = Admin_Booking_Parking.[Register_Id] Right Outer Join Admin_Rent_Space ON Admin_Rent_Space.[Parking_Id]=  Admin_Booking_Parking.Parking_Id Where  (Admin_Booking_Parking.Status =0 ) AND (Admin_Booking_Parking.Success_Id =1 )  And (Admin_Booking_Parking.Register_Id =@Register_Id ) ">
           <SelectParameters>
                                        <asp:ControlParameter ControlID="Label3" Name="Register_Id" 
  ...
  Admin_Booking_Parking.To_Date,
   ...
   Admin_Booking_Parking.Purpose,
	...
	Admin_Login.Email_Id, 
	Admin_Login.Username 
	 FROM Admin_Login Right OUTER JOIN Admin_Booking_Parking ON Admin_Login.Registration_Id = Admin_Booking_Parking.[Register_Id] Right Outer Join Admin_Rent_Space ON Admin_Rent_Space.[Parking_Id]=  Admin_Booking_Parking.Parking_Id Where  (Admin_Booking_Parking.Status =1 ) AND (Admin_Booking_Parking.Success_Id =1 )  And (Admin_Booking_Parking.Register_Id =@Register_Id )">
           <SelectParameters>
                                        <asp:ControlParameter ControlID="Label3" Name="Register_Id" 
                                            PropertyName="Text" Type="String" />
                                    </SelectParameters>
                ...
                <table class="table table-bordered table-responsive cart_summary">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="price"><span style="background-color: #333333;color: white; padding: 9px;">
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("From_Date") %>'>

                                </asp:Label><asp:Label ID="Label2" runat="server" style="margin-left: 5px;" Text='<%# Eval("From_Time") %>'></asp:Label> <span style="font-weight: 800;color: #FF9900;">To</span>
                                  <asp:Label ID="Label3" runat="server" Text='<%# Eval("To_Date") %>'></asp:Label>
                                <asp:Label ID="Label4" runat="server" style="margin-left: 5px;" Text='<%# Eval("To_Time") %>'>
  ...
  Admin_Booking_Parking.To_Date,
   ...
   Admin_Booking_Parking.Purpose,
	...
	Admin_Login.Email_Id, 
	Admin_Login.Username 
	 FROM Admin_Login Right OUTER JOIN Admin_Booking_Parking ON Admin_Login.Registration_Id = Admin_Booking_Parking.[Register_Id] Right Outer Join Admin_Rent_Space ON Admin_Rent_Space.[Parking_Id]=  Admin_Booking_Parking.Parking_Id Where  (Admin_Booking_Parking.Status =2 ) AND (Admin_Booking_Parking.Success_Id =1 )  And (Admin_Booking_Parking.Register_Id =@Register_Id ) ORDER BY [Id] DESC">
           <SelectParameters>
                                        <asp:ControlParameter ControlID="Label3" Name="Register_Id" 
                                            PropertyName="Text" Type="String" />
                                    </SelectParameters>
