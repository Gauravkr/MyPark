<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.master" AutoEventWireup="true" CodeFile="SpaceBook_Record.aspx.cs" Inherits="User_SpaceBook_Record" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <div class="container" id="columns">
        ...
        <div class="page-content">
            ...
            SelectCommand="
  SELECT Admin_Booking_Parking.From_Date,
  ...
  Admin_Booking_Parking.To_Date,
   ...
   Admin_Booking_Parking.Purpose,
	...
	Admin_Booking_Parking.[Register_Id] ,
	Admin_Rent_Space.Address, 
	Admin_Rent_Space.Parking_Name ,
	Admin_Login.Mobile_Number, 
	Admin_Login.Email_Id, 
	Admin_Login.Username 
	 FROM Admin_Booking_Parking 
	 Right OUTER JOIN Admin_Login
	 ON Admin_Booking_Parking.Register_Id = Admin_Login.Registration_Id  
	
	Right Outer join Admin_Rent_Space
	ON Admin_Rent_Space.Parking_Id = Admin_Booking_Parking.Parking_Id

	 Where (Admin_Booking_Parking.Status =0 ) AND (Admin_Booking_Parking.Success_Id =1 )  
	And  Admin_Rent_Space.Uniq_Id =@Register_Id
	">
       <SelectParameters>
  ...
  Admin_Booking_Parking.To_Date,
   ...
   Admin_Booking_Parking.Purpose,
	...
	Right Outer join Admin_Rent_Space
	ON Admin_Rent_Space.Parking_Id = Admin_Booking_Parking.Parking_Id
	 Where (Admin_Booking_Parking.Status =1 ) AND (Admin_Booking_Parking.Success_Id =1 )  
	And  Admin_Rent_Space.Uniq_Id =@Register_Id">
        <SelectParameters>
                                        <asp:ControlParameter ControlID="Label3" Name="Register_Id" 
                                            PropertyName="Text" Type="String" />
  ...
  Admin_Booking_Parking.To_Date,
   ...
   Admin_Booking_Parking.Purpose,
	...
	Right Outer join Admin_Rent_Space
	ON Admin_Rent_Space.Parking_Id = Admin_Booking_Parking.Parking_Id
	 Where (Admin_Booking_Parking.Status =2 ) AND (Admin_Booking_Parking.Success_Id =1 )  
	And  Admin_Rent_Space.Uniq_Id =@Register_Id  ">
       <SelectParameters>
                                        <asp:ControlParameter ControlID="Label3" Name="Register_Id" 
                                            PropertyName="Text" Type="String" />
